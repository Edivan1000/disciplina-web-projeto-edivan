...
import br.ueg.desenvolvimento.web.projeto_edivan.controller.Disciplina;
...
public class AlunoController {
    ...
    public String postCreate(@RequestParam String nome,
        ...
        if (disciplinas != null && !disciplinas.isEmpty()) {
            List<Disciplina> listaDisciplinas = disciplinaRepository.findAllById(disciplinas);
